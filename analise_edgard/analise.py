...
def analise_completa():
    ...
    estatisticas['SP'] = {
        ...
        'max_banheiro': vz.encontrar_max(df_sp, 'IN_BANHEIRO_PNE'),
        'max_quadra': vz.encontrar_max(df_sp, 'IN_QUADRA_ESPORTES'),
        'max_biblioteca': vz.encontrar_max(df_sp, 'IN_BIBLIOTECA'),
        'max_dorm_aluno': vz.encontrar_max(df_sp, 'IN_DORMITORIO_ALUNO'),
        'max_dorm_professor': vz.encontrar_max(df_sp, 'IN_DORMITORIO_PROFESSOR')
    }

    # Calcular as estatísticas para Minas Gerais e armazená-las no dicionário
    estatisticas['MG'] = {
        'estatisticas': vz.calcular_estatisticas(df_mg),
        'max_banheiro': vz.encontrar_max(df_mg, 'IN_BANHEIRO_PNE'),
        'max_quadra': vz.encontrar_max(df_mg, 'IN_QUADRA_ESPORTES'),
        'max_biblioteca': vz.encontrar_max(df_mg, 'IN_BIBLIOTECA'),
        'max_dorm_aluno': vz.encontrar_max(df_mg, 'IN_DORMITORIO_ALUNO'),
        'max_dorm_professor': vz.encontrar_max(df_mg, 'IN_DORMITORIO_PROFESSOR')
    }

    # Calcular as estatísticas para o Pará e armazená-las no dicionário
    estatisticas['PA'] = {
        'estatisticas': vz.calcular_estatisticas(df_pa),
        'max_banheiro': vz.encontrar_max(df_pa, 'IN_BANHEIRO_PNE'),
        'max_quadra': vz.encontrar_max(df_pa, 'IN_QUADRA_ESPORTES'),
        'max_biblioteca': vz.encontrar_max(df_pa, 'IN_BIBLIOTECA'),
        'max_dorm_aluno': vz.encontrar_max(df_pa, 'IN_DORMITORIO_ALUNO'),
        'max_dorm_professor': vz.encontrar_max(df_pa, 'IN_DORMITORIO_PROFESSOR')
    }
